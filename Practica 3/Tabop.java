	...
	String dameModo(String codop, String op, String cadenaModos){
		...
		for(int i=0;i<modos.size();i++){
			...
			switch(modos.elementAt(i)){
				...
				case "EXT":
					//Checa mediante su Clasificador o si es null el arugmento y los pendientes son 0. 
					if(Clasificador.modoExtendido(op) || (pendientes==0 && op.equals("NULL"))){
						return "EXT";	
					}
				break;
				...
				case "[IDX]":
					//Checa mediante su Clasificador o si es null el arugmento y los pendientes son 0. 
					if(Clasificador.modoIndirecto16b(op)||Clasificador.modoAcumuladorIndirecto(op)|| (pendientes==0 && op.equals("NULL"))){
						return "[IDX]";
					}
				break;
				case "REL8":
					//Checa mediante su Clasificador o si es null el arugmento y los pendientes son 0. 
					if(Clasificador.modoRelativo8b(op)|| (pendientes==0 && op.equals("NULL"))){
						return "REL8";
					}
				break;
				case "REL9":
					//Checa mediante su Clasificador o si es null el arugmento y los pendientes son 0. 
					if(Clasificador.modoRelativo9b(op)|| (pendientes==0 && op.equals("NULL"))){
						return "REL9";
					}
				break;
				case "REL16":
					//Checa mediante su Clasificador o si es null el arugmento y los pendientes son 0. 
					if(Clasificador.modoRelativo16b(op)|| (pendientes==0 && op.equals("NULL"))){
						return "REL16";
					}
				break;
