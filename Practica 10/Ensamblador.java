...
public class Ensamblador{
	...
	public void compilar(){
		...
		try{
			...
			br = new BufferedReader (new InputStreamReader (new FileInputStream (rutaArchivo+".asm"), "8859_1"));
			String linea;
			...
			bwi = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(rutaArchivo+".tmp"),"8859_1"));
			//bwe es el archivo con los errores
			bwe = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(rutaArchivo+".err"),"8859_1"));
			if(!ins.exists()) {
				ins.createNewFile();
			}
			if(!err.exists()) {
			...
			while((linea=arch.readLine())!=null){
				...
				switch(modo){
					...
					break;
						...
						Integer rr = Integer.parseInt(operando)-pc;
						if(rr<0){
							rr+=256;
						}
